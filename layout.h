...
int layer0[105] = {
  ...
  KEY_5, KEY_T, KEY_G, KEY_B, KEY_RIGHT, KEYBOARD_LEFT_ALT, KEYBOARD_LEFT_CTRL,

  KEY_6, KEY_Y, KEY_H, KEY_N, KEY_DOWN, KEY_SPACE, KEY_PAGE_DOWN,
  KEY_7, KEY_U, KEY_J, KEY_M, KEY_DUMMY, KEY_ENTER, KEY_DUMMY,
  KEY_8, KEY_I, KEY_K, KEY_COMMA, KEY_UP, KEYBOARD_RIGHT_CTRL, KEY_PAGE_UP,
