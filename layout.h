...
int layer0[105] = {
/*0*/KEY_EQUAL, KEY_TAB,      KEY_CAPS_LOCK,KEYBOARD_LEFT_SHIFT,KEY_DUMMY,      KEY_DUMMY,          KEY_DUMMY,
/*1*/KEY_1,     KEY_Q,        KEY_A,        KEY_Z,              KEY_TILDE,      KEY_DUMMY,          KEY_DUMMY,
/*2*/KEY_2,     KEY_W,        KEY_S,        KEY_X,              KEY_INSERT,     KEY_END,            KEY_DUMMY,
/*3*/KEY_3,     KEY_E,        KEY_D,        KEY_C,              KEY_LEFT,       KEY_HOME,           KEY_BACKSPACE,
/*4*/KEY_4,     KEY_R,        KEY_F,        KEY_V,              KEY_DUMMY,      KEY_DUMMY,          KEY_DELETE,
/*5*/KEY_5,     KEY_T,        KEY_G,        KEY_B,              KEY_RIGHT,      KEYBOARD_LEFT_ALT,  KEYBOARD_LEFT_CTRL,
...
/*11*/KEY_MINUS,KEY_BACKSLASH,KEY_QUOTE,    KEY_RIGHT_SHIFT,    KEY_DUMMY,      KEY_DUMMY,          KEY_DUMMY,
